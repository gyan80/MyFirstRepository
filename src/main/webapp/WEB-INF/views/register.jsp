		...
		<table width="1002" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="middle" align="center" valign="top"><br />
					<h1 style="font-family: Verdana">Sensery Registration	Panel</h1> <br />
					<center>
							...
							<table width="300" border="0" align="center" cellpadding="0"
								...
								<tr>
									<td height="34" align="center" bgcolor="#bfcfdc"><div
											style="font-family: tahoma; font-size: 16px; color: #063557; font-weight: bold; text-align: center; padding: 10px">SIGNUP</div>
									</td>
								</tr>
							</table>
								...
								<table width="304" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td style="padding: 5px 10px"><input type="submit"
											name="submit" id="button" value="Create" />
										</td>
										<td width="100px">New User <a href="./">Login</a></td>
									</tr>
								</table>
								</div>
						</form>
