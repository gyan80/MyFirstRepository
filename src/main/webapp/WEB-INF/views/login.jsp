		...
		<table width="1002" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="middle" align="center" valign="top"><br />
					...
					<center>
						<form name="input" action="/users/login" method="post">
							<table width="300" border="0" align="center" cellpadding="0"
								...
								<tr>
									<td height="34" align="center" bgcolor="#bfcfdc"><div
											style="font-family: tahoma; font-size: 16px; color: #063557; font-weight: bold; text-align: center; padding: 10px">LOGIN</div>
									</td>
								</tr>
							</table>
							<div style="border: 1px solid #cccccc; background: #FFFFFF; width: 304px; margin: 0px auto; font-size: 12px; color: #333333; font-family: tahoma">
								...
								<tr align="center" style="color: red;">${msg}</tr>
									<tr>
										<td align="right" valign="top" style="padding: 5px 10px">User ID</td>
										<td align="left" valign="top" style="padding: 5px 10px">
											<input type="text" name="EncryptedValue" id="textfield" />
										</td>
									</tr>
									<tr>
										<td align="right" valign="top" style="padding: 5px 10px"'>Password</td>
										<td align="left" valign="top" style="padding: 5px 10px"'><input
											type="password" name="password" id="textfield" /></td>
									</tr>
									<tr>
										...
										<td width="100px">New User <a href="./newuser">Signup</a></td>
									</tr>
								</table>
								</div>
						</form>
